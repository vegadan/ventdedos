...
const labels = [
  ...
  { name: "LITUANIE", x: 24.0, y: 55.5, size: 5 },
  { name: "LETTONIE", x: 26.0, y: 56.8, size: 5 },
  { name: "ESTONIE", x: 26.0, y: 58.6, size: 5 },
  { name: "RUSSIE", x: 32.0, y: 57.5, size: 5 },
  { name: "BIÉLORUSSIE", x: 28, y: 53.3, size: 5 },
  ...
  { name: "MONTÉNÉGRO", x: 19.3, y: 42.8, size: 1.7 },
  { name: "KOSOVO", x: 20.9, y: 42.6, size: 2.0 },
  { name: "MACÉDOINE", x: 21.8, y: 41.6, size: 2.5 },
  { name: "SERBIE", x: 20.7, y: 44.0, size: 3 },
  { name: "HONGRIE", x: 19.3, y: 47.0, size: 5 },
  { name: "SLOVAQUIE", x: 19.9, y: 48.8, size: 5 },
  ...
  { name: "UKRAINE", x: 29.0, y: 49.5, size: 5 },
